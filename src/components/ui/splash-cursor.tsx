...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Custom colors biased towards purples and blues for our theme
      let h = 0.6 + Math.random() * 0.2; // 0.6-0.8 range for purples/blues
      let s = 0.65 + Math.random() * 0.35; // High saturation
      let v = 0.5 + Math.random() * 0.5; // Medium to high brightness
